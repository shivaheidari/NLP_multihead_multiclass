'''
takes encoder: pretrained model and num_classes: dict[str, int]

forward: accespts input_id, attention mask

labels_modality, labels_vendor, labels_series_type, labels_plane, labels_acquisition, labels_body, labels_contrast
